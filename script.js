...
$(document).ready(function(){
    ...
    const mudaTela = ( atual, nova = null, animacao = "fade", tempoAnimacao = 900 ) => {
        ...
        if(nova == 5){
            var audio = new Audio('./imagens/cbjr.mp3');
            audio.volume = 0.1;
            audio.play();
        }
    ...
    const mostraMsgMes = (texto) =>{
        ...
        switch(texto){
            ...
            case "17/10": titulo = "15 de Outubro de 2017"; mensagem = "<p>Foi a partir desse dia que a gente começou a ficar direto. Gabriel pegou a gente no flagra se beijando na rua kkkkk rs</p>";break;
